...
import { UIManager, Platform, TouchableOpacity } from 'react-native';
  ...
  return (
    <AnnouncementStackScreen.Navigator initialRouteName='Announcement list'>
      ...
      <AnnouncementStackScreen.Screen
        ...
        initialParams={{ id: null, createdAt: null, createdBy: null, title: null, hyperlink: null, description: null }}
      />
      <AnnouncementStackScreen.Screen
